...
import { getClinicUsers, updateClinicStaff, deleteClinicStaff, createClinicStaff } from './actions';
...
export function ClinicStaffList() {
  ...
  async function saveEdit(id: number) {
    await updateClinicStaff(id, editForm);
    setEditingId(null);
    setRefresh((n) => n + 1);
  }
  ...
  async function handleDelete(id: number) {
    ...
    await deleteClinicStaff(id);
    setRefresh((n) => n + 1);
  }

  async function handleAdd() {
    await createClinicStaff(addForm);
    setShowAdd(false);
      ...
      <CardHeader>
        <div className="flex items-center justify-between">
          <div>
            ...
            <CardDescription>Manage staff members in your clinic.</CardDescription>
          </div>
      ...
      <CardContent>
        {showAdd && (
          <div className="mb-4 rounded-lg border p-4 space-y-3">
            <h4 className="font-medium text-sm">New Staff Member</h4>
